...
export function DataTable({ variant = 'header', items, setItems, showAddRow, isError, ...props }: DataTableProps) {
    ...
    const handleNewRowChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (name === 'qty_in_figures' && Number(value) < 0) {
            return;
        }
                    ...
                    <div className="">
                        <table className="min-w-full divide-y divide-gray-200 text-gray-900">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-4 py-2 text-left text-xs font-medium tracking-wider uppercase">#</th>
